...
class Parser():
    ...
    def utilitynav(self):
    	...
    	links = {'http://nymag.com/':('/html/body/div[2]/div/header/nav[2]/div/ul/li/a','http://nymag.com/index.htm','nymag.com', 'New York Magazine -- NYC Guide to Restaurants, Fashion, Nightlife, Shopping, Politics, Movies'), \
    		 ...
    		 'https://ssl.palmcoastd.com/03921/apps/-180323?iKey=I**BMD&':('/html/body/div[2]/div/header/nav[2]/div/ul/li[2]/div/ul/li[2]/a', 'http://nymag.com/redirects/circ_subscribe/utility-bar.html', 'Subscribe Now', 'New York magazine Subscriptions'), \
    		 'https://secure.palmcoastd.com/pcd/eSv?iMagId=03921&i4Ky=IGH5':('/html/body/div[2]/div/header/nav[2]/div/ul/li[2]/div/ul/li[3]/a', 'http://nymag.com/redirects/circ_gifts/utility-bar.html', 'Give a Gift Subscription', 'https://secure.palmcoastd.com/pcd/eSv?iMagId=03921&i4Ky=IGH5'), \
    		 ...
    		 'http://nymag.com/daily/fashion/':('/html/body/div[2]/div/header/nav[2]/div/ul/li[5]/a', 'http://nymag.com/daily/fashion/', 'The Cut', 'The Cut -- Fashion Week, Models, Street Style, Red Carpet Dresses and Fashion News'), \
               	 'http://nymag.com/daily/intel/':('/html/body/div[2]/div/header/nav[2]/div/ul/li[3]/a', 'http://nymag.com/daily/intel/', 'Daily Intel', 'Daily Intel -- New York News -- New York Magazine')} 
