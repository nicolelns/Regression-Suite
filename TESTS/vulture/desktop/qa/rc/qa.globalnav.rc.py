...
TEST = "Cross Site Global Navigation - Desktop - Vulture"
...
CSS = open('../data/text/cross-site-nav.css.txt', 'r').readlines()		
DATA = pickle.load(open('../data/pickle/cross-site-nav.data.p', 'rb')) 	
...
class CrossSiteNav(unittest.TestCase):
