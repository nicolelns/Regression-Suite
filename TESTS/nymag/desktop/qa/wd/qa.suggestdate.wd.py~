...
class RelatedStories(unittest.TestCase):
	...
	for each in CSS:
        ...
        self.b_url_match_test()   
        self.c_clicky_test()    
            
        ########################################################################
        
    def b_url_match_test(self):
	...
	driver = self.driver
        ...
        for each in keys:
            ...
            try:
    	        ...
    	        time.sleep(3)
                title = driver.title
                if re.search('404', title) or re.search('Not Found', title, re.I):
                    L.log(BROWSERS[0], "Test C - Function", "FAIL, 404 in title", href)
        
            except Exception as e:
                self.verificationErrors.append(str(e) + href)	
            	L.log(BROWSERS[0], "Test C - Function", "FAIL, LINK DOES NOT WORK", href, exception=str(e))  
            ...
            if img is not None:
                ...
                try:
            	    ...
            	    L.log(BROWSERS[0], "Test C - Function", "IMG, LINK DOES NOT WORK", img, exception=str(e))  
