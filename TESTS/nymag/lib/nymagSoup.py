...
class Parser():
    ...
    def utilitynav(self):
    	...
    	links = {'http://nymag.com/':('/html/body/div[2]/div/div/div[2]/div/ul/li/a','http://nymag.com/index.htm','nymag.com', 'New York Magazine -- NYC Guide to Restaurants, Fashion, Nightlife, Shopping, Politics, Movies'), \
    		 'http://nymag.com/nymag/toc/20120625/':('/html/body/div[2]/div/div/div[2]/div/ul/li[2]/div/ul/li/a', 'http://nymag.com/includes/tableofcontents.htm', 'Table of Contents', 'Table of Contents -- June 25, 2012 Issue of New York Magazine'), \
    		 'https://ssl.palmcoastd.com/03921/apps/-180323?iKey=I**BMD&':('/html/body/div[2]/div/div/div[2]/div/ul/li[2]/div/ul/li[2]/a', 'http://stg.nymetro.com/redirects/circ_subscribe/utility-bar.html', 'Subscribe Now', 'New York magazine Subscriptions'), \
    		 'https://secure.palmcoastd.com/pcd/eSv?iMagId=03921&i4Ky=IGH5':('/html/body/div[2]/div/div/div[2]/div/ul/li[2]/div/ul/li[3]/a', 'http://stg.nymetro.com/redirects/circ_gifts/utility-bar.html', 'Give a Gift Subscription', 'https://secure.palmcoastd.com/pcd/eSv?iMagId=03921&i4Ky=IGH5'), \
    		 ...
    		 'http://stg.nymetro.com/daily/fashion/':('/html/body/div[2]/div/div/div[2]/div/ul/li[5]/a', 'http://stg.nymetro.com/daily/fashion/', 'The Cut', 'The Cut -- Fashion Week, Models, Street Style, Red Carpet Dresses and Fashion News'), \
