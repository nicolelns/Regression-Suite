...
TEST = "The Cut - Desktop - Share Tools"
...
"""
This is a test for the share tools on Cut articles:
...
class ShareTools(unittest.TestCase):
...
for x in range(0,3):
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(ShareTools)
