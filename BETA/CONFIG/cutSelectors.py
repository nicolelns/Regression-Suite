...
class Global(self):
    ...
    def cut_nav(self):
    	...
    	return {"links":(('li[class*="fashions cutSectionItem"] a.sectionLink', "http://nymag.com/thecut/fashion/"),
    ...
    def universal_nav(self):
    	...
    	The values in the dictionary that are tuples are CSS selectors for links in index[0], 
    	and the correct landing URL in index[1].
    	
    	"""
        regex:re.compile('http:\/\/nymag.com\/nymag\/toc\/[0-9]{4}')
    	
        return {"static_links":(('a.nymagLink', 'http://nymag.com/'),
    ...
    def search(self):
    	...
    	return {"search_bar":'input.text', "search_button":'button[id*="btn-ny-search"]'}

    def footer(self):
    	    
    	# Common to all pages
    	
    	return {"cut_logo":'div.theCutLogo',
    ...
    def login_reg_links(self):
    	...
    	return "login_link":'a.login-lightbox', "register_link":'a.register-lightbox'}
    	
    def login_lightbox(self):
    	    
    	# Contains elements inside the lightbox after link to log in is clicked    
    	
    	return {"lightbox":'div#login-litebx.litebx-content[class*="login-box"]',
    	        ...
    	        "ogin_status":'div#login_status.status-wrp[class*="status-wrp status-error"]',
    ...
    def register_lightbox(self):
    	...
    	return {"lightbox:'div#login-litebx.litebx-content[class*="reg-box"]',
        http://jira.dev.nymag.biz/browse/REM-457"create_acct_text:'div#registration-litebx.litebx-content div.head h1',
    ...
    def social(self):
    	...
    	return {"facebook":'form#u860xix2 div.pluginConnectButton div.pluginButton div button',
    	        "twitter":'a#follow-button.btn span#l.label'}
        
    def feedback_tab(self):
    	    
    	return {"tab":'a.feedbackLink i.shortHeadline', 'http://www.surveygizmo.com/s3/1024147/Share-your-feedback-with-The-Cut'}
...
class HomePage():
    ...
    def small_pictures_module(self):
        ...
        return {"small_pictures_section":'section[class*="module clearfix featuredSlideshowWrap"]',
    ...
    def partners_module(self):
    	...
    	return {"from_our_partners":'article[class*="module clearfix partners"] h1',
    ...
    def news_feed(self):
    	...
    	return {"the_latest_link":'h1[class*="feedTitle"] a',
    ...
    def most_popular(self):
    	...
    	return {"most_popular_section":'article[class*="module mostPopular"]',
                "most_popular_heading":'article[class*="module mostPopular"] h1',
                "most_popular_link":'article > ol > li > a'}
        
    def love_war(self):
    	    
    	return {"love_war_section":'div[class*="parbase loveAndWar section"]',
    ...
    def lookbook(self):
    	...
    	return {"look_book_section":'article[class*="clearfix lookbooksWrap"]',
    ...
    def lede(self):
        ...
        return {"lede_article":'li.ledeArticle',
    ...
    def goods(self):
    	...
    	return {"goods_promo_section":'section[class*="goodsWrap"]',
    ...
    def ads(self):
    	...
    	return {"desktop_leaderboard_ad":'div[id*="nymTakeover"]',
    ...
    def video_module(self):
    	...
    	return {"video_section":'article[class*="module clearfix videoModule"]',
    	        "video_url":'a.vidBox',
    	        "video_headline":'p.title'}
        
    def interview_module(self):
    	    
    	return {"interview_section":'div[class*="parbase interview section"]',
    ...
    def giant_image(self):
    	...
    	return {"giant_img_section":'div[class*="largeImageSlideshow parbase section"]',
    ...
    def find_collection(self):
    	...
    	return {"collection_section":'section[class*="module collectionFinderWrap"]',
    ...
    def giant_ad_component(self):
    	...
    	return {"ad_section":'div.adGalleryLarge',
    ...
    def twitter(self):
    	...
    	return {"twitter_headline":'section[class*="module clearfix twitter socialModule"] > header.header > h3.hed',
    ...
    def facebook(self):
    	...
    	return {"fb_headline":'section[class*="module clearfix facebook socialModule"] > header.header > h3.hed',
    	        "fb_link":'section[class*="module clearfix facebook socialModule"] > div.content > p.contentText > a',
    	        "fb_button":'a.follow-facebook-url'}
    	
    def instagram(self):
    	    
    	return {"inst_headline":'section[class*="module clearfix instagram socialModule"] > header.header > h3.hed',
    	        "inst_link":'a.follow-instagram-img-url > img.follow-instagram-img',
    	        "inst_button":'a.follow-instagram-url'}
    	
    def pinterest(self):
    	    
    	return {"pinterest_section_headline":'section[class*="module clearfix pins"] > header.header > h3.hed',
    ...
    def newsletter(self):
    	...
    	return {"newsletter_section_headline":'section#fashion-alert-newsletter-promo[class*="module clearfix newsletter"] > header.header > h3.hed',
    ...
    def apps(self):
    	...
    	return {"apps_section_headline":'section[class*="module clearfix appsModule"] > header.header h3.hed',
...
class BeautySplash():
    ...
    def partner_feed(self):
    	...
    	return {"partner_feed":'div#partner-feeds.partner-feeds',
    ...
    def lede(self):
        ...
        return  {"lede_headline":'a.ledeHeadlineLink',
    ...
    def article(self):
        ...
        return {"newsfeed_headline":'div.filters h3',
    ...
    def ads(self):
        ...
        return {"lb_above_nav":'',  # lb":leaderboard
...
class GoodsSplash():
    ...
    def article(self):
        ...
        return {"article_headline":'article#entry.goodsEntry header h3 a',
...
class FameSplash():
    ...
    def look_book(self):
    	...
    	return {"lookbook_section":'div[class*="parbase lookbooks"]',
