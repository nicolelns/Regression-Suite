...
CSS = open('../data/text/footer.css.txt', 'r').readlines()		# a = presence; Is it there?
DATA = pickle.load(open('../data/pickle/footer.data.p', 'rb')) 	        # c = function; Does the module work?
