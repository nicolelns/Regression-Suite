...
CSS = open('../data/text/latesttalk.css.txt', 'r').readlines()		# a = presence; Is it there?
DATA = pickle.load(open('../data/pickle/latesttalk.data.p', 'rb')) 	        # c = function; Does the module work?           
	...
	for each in DATA:
	    ...
	    d = DATA[n] 
            ...
            try:
                ...
                elif re.search('/news/talk', d, re.I):
                    pass
            
                elif re.search('#comment', d, re.I):
                    pass
