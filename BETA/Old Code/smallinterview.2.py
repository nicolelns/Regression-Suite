...
TEST = "Small Interview Module - Desktop - Vulture"
...
CSS = open('../data/text/smallinterview.css.txt', 'r').readlines()		# a = presence; Is it there?
DATA = pickle.load(open('../data/pickle/smallinterview.data.p', 'rb')) 	        # c = function; Does the module work?
