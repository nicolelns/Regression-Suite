...
TEST = "Popular Stories Module"

L = Logger.MainLogger(BASEURL, TEST)
S = vultureSoup.Parser()

S.popstories()			# Call the relevant BeautifulSoup function (usually same name as test)

CSS = open('../data/text/popstories.css.txt', 'r').readlines()		# a = presence; Is it there?
DATA = pickle.load(open('../data/pickle/popstories.data.p', 'rb')) 	        # c = function; Does the module work?

x = 0

"""This is a regression test for the Popular Stories module on Vulture's home page"""
...
class PopStories(unittest.TestCase):
	...
	# The title matching portion of this module needs tweaking; it doesn't conform to the other standards, i.e.
        # Text for link matches/is part of article's title	
...
for each in BROWSERS:
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(PopStories)
