...
TEST = "TV Recap Module - Desktop - Vulture Home Page"
...
CSS = open('../data/text/tvrecap.css.txt', 'r').readlines()		# a = presence; Is it there?
DATA = pickle.load(open('../data/pickle/tvrecap.data.p', 'rb')) 	        # c = function; Does the module work?           
SHOWS = pickle.load(open('../data/pickle/tvrecap_shows.data.p', 'rb'))
