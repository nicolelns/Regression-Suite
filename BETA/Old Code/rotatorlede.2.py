...
TEST = "Rotating Lede - Desktop - Vulture Home Page"
...
CSS = open('../data/text/rotatorlede.css.txt', 'r').readlines()		# a = presence; Is it there?
DATA = pickle.load(open('../data/pickle/rotatorlede.data.p', 'rb')) 	        # c = function; Does the module work?
