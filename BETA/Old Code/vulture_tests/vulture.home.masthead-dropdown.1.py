...
TEST = "Masthead Dropdown Module"

DATA = open('../data/vulture.home.masthead-dropdown.css.txt', 'r').readlines()

L = Logger.MainLogger(BASEURL, TEST)
x = 0

# This test opens www.vulture.com and does the following:
#	Tests the Hot Topics module for the presence of elements
	

class MastHeadDropdown(unittest.TestCase):
...
for each in BROWSERS:
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(MastHeadDropdown)
