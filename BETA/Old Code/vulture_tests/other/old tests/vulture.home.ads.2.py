...
DATA = open('../data/vulture.home.ads.css.txt', 'r').readlines()

L = Logger.MainLogger(BASEURL, TEST)
x = 0

# This test opens www.vulture.com and does the following:
#	Tests the presence and location of the ad boxes
...
class Ads(unittest.TestCase):
    ...
    # Tests for the presence of the ads on the page in the right location
