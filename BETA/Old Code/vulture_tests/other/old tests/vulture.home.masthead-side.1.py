...
TEST = "Side Masthead Module - Contains Producer/Editor info, etc"

DATA = open('../data/vulture.home.masthead-side.css.txt', 'r').readlines()
...
class SideMast(unittest.TestCase):
...
for each in BROWSERS:
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(SideMast)
