...
DATA = open('../data/vulture.pcf.footer.css.txt', 'r').readlines()

L = Logger.MainLogger(BASEURL, TEST)
x = 0

# This test opens www.vulture.com and does the following:
#	Tests the Vulture footer (above the copyright footer) for the presence of elements
...
class Footer(unittest.TestCase):
    ...
    # Tests for the presence of elements in the footer
