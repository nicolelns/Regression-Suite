...
CSS = open('../data/vulture.home.thefeed.css.txt', 'r').readlines()		# a = presence; Is it there? 
DATA = open('../data/vulture.home.thefeed.data.txt', 'r').readlines()  	        # c = function; Does the module work?
