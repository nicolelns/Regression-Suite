...
TEST = "Keep Up with Vulture Module"

L = Logger.MainLogger(BASEURL, TEST)

CSS = open('../data/vulture.home.keepup.css.txt', 'r').readlines()
DATA = ('http://www.twitter.com/#!/vulture', 'http://feeds.feedburner.com/nymag/vulture')
        

x = 0

# This test needs to integrate the Facebook app


"""This is a regression test for the Keep Up with Vulture module on Vulture's home page"""
