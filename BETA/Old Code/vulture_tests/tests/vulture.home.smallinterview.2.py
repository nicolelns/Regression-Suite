...
TEST = "Small Interview Module"

L = Logger.MainLogger(BASEURL, TEST)
S = vultureSoup.Parser()

S.smallinterview()			# Call the relevant BeautifulSoup function (usually same name as test)

CSS = open('../data/vulture.home.smallinterview.css.txt', 'r').readlines()
CONTENT = open('../data/vulture.home.smallinterview.content.txt', 'r').readlines()
DATA = open('../data/vulture.home.smallinterview.data.txt', 'r').readlines()

x = 0

"""This is a regression test for the Small Interview module on Vulture's home page"""
...
class SmallInterview(unittest.TestCase):
...
for each in BROWSERS:
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(SmallInterview)
