...
CONTENT = "2010 2011, New York Media LLC. All Rights Reserved. Vulture"         # b = content; Is the right stuff there?
...
class CpFooter(unittest.TestCase):
	...
	for each in DATA:
        ...
        # Third, make sure the correct number of links are in the Copyright Footer    
            
        count = sel.get_css_count("css=" + CSS[2])
        
        if count != 9:
            L.log(BROWSERS[x], TEST, "FAIL, Missing Footer Links", str(count) + " links found")
            
        # Fourth, make sure the copyright statement is on the page
