...
TEST = "Masthead Module (Links to Editorial Biographies)"

L = Logger.MainLogger(BASEURL, TEST)
S = vultureSoup.Parser()

CSS = open('../data/vulture.home.masthead.css.txt', 'r').readlines()
DATA = open('../data/vulture.home.masthead.data.txt', 'r').readlines()
