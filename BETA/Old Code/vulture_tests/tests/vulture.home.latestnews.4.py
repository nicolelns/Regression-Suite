...
S.latestnews()			# Call the relevant BeautifulSoup function (usually same name as test)

CSS = open('../data/vulture.home.latestnews.css.txt', 'r').readlines()		# a = presence; Is it there?CONTENT = open('../data/vulture.home.tmmatb.content.txt', 'r').readlines()      # b = content; Does the module have the right stuff?
DATA = open('../data/vulture.home.latestnews.data.txt', 'r').readlines()  	        # c = function; Does the module work?
