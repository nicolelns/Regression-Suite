...
CSS = open('../data/vulture.home.newreviews.css.txt', 'r').readlines()		# a = presence; Is it there?
CONTENT = open('../data/vulture.home.newreviews.content.txt', 'r').readlines()  # b = content; Does it have the right stuff? 
DATA = open('../data/vulture.home.newreviews.data.txt', 'r').readlines()  	# c = function; Does the module work?
...
class NewReviews(unittest.TestCase):
	...
	for each in DATA:
        ...
        if S.newreviews() != (5,5):
            print "Missing Content in New Reviews!"
            print S.newreviews()
