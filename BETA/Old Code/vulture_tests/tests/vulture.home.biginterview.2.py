...
CSS = open('../data/vulture.home.biginterview.css.txt', 'r').readlines()
CONTENT = open('../data/vulture.home.biginterview.content.txt', 'r').readlines()
DATA = open('../data/vulture.home.biginterview.data.txt', 'r').readlines()
