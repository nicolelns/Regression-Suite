...
TEST = "Viral Video Module - Desktop - Vulture Home Page"
...
CSS = open('../data/text/viralvideo.css.txt', 'r').readlines()		# a = presence; Is it there?
DATA = pickle.load(open('../data/pickle/viralvideo.data.p', 'rb')) 	        # c = function; Does the module work?
...
Test 'b' is a 'content' test:  Do the eleme nts contain the relevant data?  
