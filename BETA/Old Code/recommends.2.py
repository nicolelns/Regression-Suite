...
TEST = "Recommends Module"

L = Logger.MainLogger(BASEURL, TEST)
S = vultureSoup.Parser()

S.recommends()			# Call the relevant BeautifulSoup function (usually same name as test)

CSS = open('../data/text/recommends.css.txt', 'r').readlines()		# a = presence; Is it there?
DATA = pickle.load(open('../data/pickle/recommends.data.p', 'rb')) 	        # c = function; Does the module work?

x = 0

"""This is a regression test for the Recommends module on Vulture's home page"""
...
class Recommends(unittest.TestCase):
    ...
    # This test needs some work in regards to the "get text" section: 
    # Due to the structure of the urls in this module, it needs tweaking
...
for each in BROWSERS:
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(Recommends)
