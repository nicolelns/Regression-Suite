...
class Login(unittest.TestCase):
	...
	m = n = 0
	    ...
	    try:
                ...
                time.sleep(2)
                self.nymag_register_form_fill(usrs[n], emails[n], pwds[n], zips[n], n)
    ...
    def nymag_register_form_fill(self, usr, email, pwd, zipcode, z):
	    ...
	    self.nym_register_form_button(self.count)
    ...
    def nym_register_form_buttons(self, z):
	    ...
	    for n in range(0,2):
	        ...
	        if n == 0:
	            if (self.counter == 3) and (len(errors) == 1):
	            ...
	            if (self.counter == 3) and (len(errors) == 2):
	            	L.log(BROWSERS[x], test, "PASS, FORM IS OK", "")
	            	print "PASS, FORM OK"
	            else:
		    	L.log(BROWSERS[x], test, "FAIL, TOO MANY ERRORS", str(len(errors)))
