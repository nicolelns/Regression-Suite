...
CSS = open('../data/text/latestnews.css.txt', 'r').readlines()		# a = presence; Is it there?
DATA = pickle.load(open('../data/pickle/latestnews.data.p', 'rb')) 	        # c = function; Does the module work?
